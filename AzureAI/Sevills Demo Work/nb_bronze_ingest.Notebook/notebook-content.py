...
tables = spark.sql("SHOW TABLES IN LH_Logibuddy")
...
spark.table("Bronze.LH_Logibuddy.dbo.bronze_orders").printSchema()
spark.table("Bronze.LH_Logibuddy.dbo.bronze_dockets").printSchema()
